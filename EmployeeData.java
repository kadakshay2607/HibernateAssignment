...
public class EmployeeData {
	...
	public void upData() {
		...
		System.out.println("update Name press 1 / Empno press 2 / Empjoindate press 3");
		...
		try {
            ...
            if (ch == 1) {
            	...
            	String empnoo = scanner.nextLine();
            	 scanner.nextLine();
            	System.out.println("Enter Empid");
            	int ide =scanner.nextInt();
            	...
            	System.out.println("Enter Empid");
            	int ide =scanner.nextInt();
            	Date date = new SimpleDateFormat("dd-MM-yyyy").parse(datee);
            	java.sql.Date date2 = new java.sql.Date(date.getTime());
            	String update = "update Employee set empjoindate= :empjoindate where empid = :empid";
    			Query query = manager.createQuery(update);
    			query.setParameter("empjoindate", date2);
    			query.setParameter("empid", ide);
    			int result = query.executeUpdate();
    			System.out.println("Data Updated");
			}
